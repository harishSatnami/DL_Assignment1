...
from gradient_descent_FFNN import gradient_descent , gradient_descent_mini_batch
...
def train_model(X, Y, epochs=1, num_of_hidden_layers=1, size_of_layers=4, learning_rate=0.1, optimizer="sgd", batch_size=4, weight_init_type=random_initialize, activation_function=sigmoid_vector):
    ...
    for epoch in range(epochs):
        ...
        Weights, Biases = gradient(X,Y,learning_rate,num_of_hidden_layers+2,num_of_batchs,batch_size,size_of_layers,Y.shape[1],Weights,Biases)
